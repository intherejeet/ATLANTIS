...
class Config(Tap):
    ...
    num_samples: int = 3  # how many samples per each category in batch
    bs: int = 300  # batch size per GPU, e.g. --num_samples 3 --bs 900 means each iteration we sample 300 categories with 3 samples
    ...
    eval_ep: str = "r(5,100,5)"  # epochs for evaluation, [] or range "r(start,end,step)", e.g. "r(10,70,20)+[200]" means 10, 30, 50, 200"""
